SECTION = "kernel"
DESCRIPTION = "Linux kernel for Grinn ChiliSOM EVB Lite, based on am335x-kernel"
LICENSE = "GPLv2"
...
do_compile_prepend() {
	...
	cp ${WORKDIR}/htc_9271.fw ${S}/firmware/
}
...
PATCHES_OVER_PSP = " \
	...
	file://chilisom-evb-lite/board-am335xevm.c.patch \
	file://chilisom-evb-lite/devices.c.patch \
	file://chilisom-evb-lite/tps65217.c.patch \
	file://chilisom-evb-lite/Kconfig.patch \
"
